...
export default class CategoryPositionSelector extends Component {
    ...
    render() {
        ...
        let actions = [
            <button onClick={this.props.startWithFlashcards}>
                <h3>Start!</h3>
            </button>,
        ...
        return (
            <div>
                <Dialog
                    ...
                    actions={actions}
                    open={open}
                    contentStyle={{ width: "100%", padding: 10, borderRadius: 14, backgroundColor: "orange" }}
                    bodyStyle={{ padding: "0 2px", overflowY: "inherit", borderRadius: 14, backgroundColor: "orange" }}>
